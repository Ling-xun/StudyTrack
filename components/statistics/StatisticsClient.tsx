        ...
        <div className="space-y-6">
          ...
          <section className="grid gap-6 lg:grid-cols-2">
            <Card>
              ...
              <p className="mt-3 text-3xl font-bold text-slate-950">{statistics.topCategory?.name ?? "暂无"}</p>
            ...
            <Card>
              ...
              <p className="mt-3 text-2xl font-bold text-slate-950">{statistics.latestCheckIn?.title ?? "暂无"}</p>
              <p className="mt-2 text-sm text-slate-500">
